...
const Navbar = () => {
  ...
  return (
    <nav
      className={`z-50 border-2 border-gray-200 dark:border-gray-700 rounded-3xl w-fit mt-4 md:mt-10 flex flex-wrap md:flex-nowrap justify-between items-center bg-white/90 dark:bg-gray-800/90 backdrop-blur-md shadow-lg transition-all duration-500 gap-2 md:gap-0 p-2 md:p-0 ${
    ...
    >
      ...
      <div className="flex justify-center gap-2 md:gap-4 ml-0 md:ml-2">
        <a
          ...
          className="group p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200"
          aria-label="LinkedIn"
        >
          <Image
      ...
      <button
        onClick={toggleTheme}
        className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 ml-0 md:ml-2"
      ...
      <button
        ...
        className="bg-black text-white dark:bg-white dark:text-black rounded-2xl text-sm md:text-base px-4 md:px-6 py-2 m-[1.5px] ml-2 font-semibold 
